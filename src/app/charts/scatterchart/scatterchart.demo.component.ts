...
<iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-v4-scatterchart?embed=1&file=app/charts/scatterchart/scatterchart.demo.html" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
...
export class ScatterChartDemoComponent implements OnInit {
  ...
  getHtmlAndTypeScriptCode() {
    ...
    //HTML FILE
    this.http.get('assets/data/code/charts/scatterchart/chart.html').subscribe(data => {
    ...
    //DataSource FILE
    this.http.get('assets/data/code/charts/scatterchart/datasource.json').subscribe(data => {
      responseTs = data.text();
    }, error => {
    }, () => {
