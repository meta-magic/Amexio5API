        ...
        <amexio-tab-view>
          ...
          <amexio-tab title="API Reference">
            <amexio-datagrid title="Chart Properties" [enable-column-fiter]="false"
                             [http-method]="'get'"
                             [http-url]="'assets/apireference/charts/candlestickchart.json'"
                             [data-reader]="'chart'"
...
<iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-v4-candlestickchart" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
...
export class CandlestickChart implements OnInit {
  ...
  getHtmlAndTypeScriptCode() {
    ...
    //HTML FILE
    this.http.get('assets/data/code/charts/candlestickchart/chart.html').subscribe(data => {
    ...
    //DataSource FILE
    this.http.get('assets/data/code/charts/candlestickchart/datasource.json').subscribe(data => {
      responseTs = data.text();
    }, error => {
    }, () => {
