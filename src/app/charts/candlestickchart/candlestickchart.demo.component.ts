      ...
      <amexio-body>
        ...
        <amexio-tab-view>
          ...
          <amexio-tab title="API Reference">
            <amexio-datagrid title="Chart Properties<amexio-chart-candlestick>" [enable-column-fiter]="false"
                             [http-method]="'get'"
...
<iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-v4-candlestickchart?embed=1&file=app/charts/candlestickchart/candlestickchart.demo.html" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
