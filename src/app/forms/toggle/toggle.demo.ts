        ...
        <amexio-tab-view>
            ...
            <amexio-row>
              <amexio-column [size]="6">
                <amexio-card [enableHeader]="true">
                  ...
                  <amexio-body>
                    <amexio-toggle [fieldLabel]="'Round Toogle'"></amexio-toggle>
                  </amexio-body>
                </amexio-card>
              </amexio-column>
              <amexio-column [size]="6">
          ...
          <amexio-tab title="API Reference">
            <amexio-datagrid title="Properties" [columnToggle]="false"
                             [httpMethod]="'get'"
                             [httpUrl]="'assets/apireference/forms/toggle.json'" 
            ...
            <amexio-datagrid title="Events" [httpMethod]="'get'" 
                             [httpUrl]="'assets/apireference/forms/toggle.json'" [dataReader]="'events'"
                             [filtering]="false">
              <amexio-data-table-column [dataIndex]="'name'" [dataType]="'string'" [hidden]="false"
                                        [text]="'Name'"></amexio-data-table-column>
              <amexio-data-table-column [dataIndex]="'description'" [dataType]="'string'" [hidden]="false"
