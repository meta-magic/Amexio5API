      ...
      <amexio-body>
        ...
        <amexio-tab-view>
                ...
                <amexio-card [header]="true">
                  ...
                  <amexio-body>
                    <amexio-number-input  [enable-popover]="true" [field-label]="'Age'" 
                                          [place-holder]="'Enter age'"
                                          [allow-blank]="true" [error-msg] ="'Please enter age'"
                                          [min-value]="1"
          ...
          <amexio-tab title="API Reference">
            <amexio-datagrid title="Properties <amexio-number-input>" [enable-column-fiter]="false"
                             [http-method]="'get'"
...
<iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-v4-number?embed=1&file=app/forms/number/number.demo.html" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
