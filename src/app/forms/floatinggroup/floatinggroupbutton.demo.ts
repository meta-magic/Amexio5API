      ...
      <amexio-body>
        ...
        <amexio-tab-view>
          ...
          <amexio-tab title="API Reference">
            ...
            <amexio-datagrid title="Properties <amexio-floating-group-button>" [enable-column-fiter]="false"
                             [http-method]="'get'"
                             [http-url]="'assets/apireference/forms/floatinggroupbutton.json'"
          ...
          src="https://stackblitz.com/edit/amexio-v41-floatingbuttongroup?embed=1&file=app/app.component.ts&view=editor" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
