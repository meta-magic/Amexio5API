...
<amexio-data-table-column [width]="65" [data-index]="'description'" [data-type]="'string'" [hidden]="false"
         ...
         <iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-timeline?embed=1&file=app/timeline-demo/timeline/timeline.demo.html&view=editor" frameborder="0" allowfullscren="allowfullscren"></iframe>
         </amexio-tab>
       </amexio-tab-view>
     </amexio-body>
   </amexio-card>
