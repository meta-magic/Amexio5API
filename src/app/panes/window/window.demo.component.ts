    ...
    <amexio-body>
        ...
        <amexio-tab-view>
                    ...
                    <amexio-body>
                        <amexio-row>
                            <amexio-column [size]="4">
                                <amexio-button type="success" (onClick)="toggleBasicWindow('material')" label="Basic Window"></amexio-button>
                                <amexio-window [body-height]="40" [(show)]="showBasicWindowMaterial" [close-on-escape]="true" [material-design]="true" [footer]="true"
                                        ...
                                        <amexio-row>
                                            <amexio-column [size]="6">
                                                <amexio-text-input [field-label]="'Name'" name="country" [place-holder]="'Enter name'" [enable-popover]="true" [icon-feedback]="true"
                                                    [allow-blank]="false" [error-msg]="'Please enter name'" [min-length]="3"
                                                    [max-length]="15" [min-error-msg]="'Name should be minimum 3 characters'"
                                            ...
                                            <amexio-column [size]="6">
                                                <amexio-text-input [field-label]="'Surname'" name="name" [place-holder]="'Enter surname'" [enable-popover]="true" [icon-feedback]="true"
                                                    [allow-blank]="false" [error-msg]="'Please enter Surname'" [min-length]="3"
                                                    [max-length]="15" [min-error-msg]="'Surname should be minimum 3 characters'"
                            ...
                            <amexio-column [size]="4">
                                ...
                                <amexio-window [(show)]="showMaxWindowMaterial" [footer]="true" [material-design]="true" (close)="toggleMaxWindow('material')"
                                    [maximize]="true">
                                    <amexio-header>
                                        Employee Form
                                    </amexio-header>
                            ...
                            <amexio-column [size]="4">
                                ...
                                <amexio-window [(show)]="showClosableMaterial" [close-on-escape]="false" [material-design]="true" [closable]="true" (close)="toggleClosable('material')">
                                    <amexio-header>
                                        Employee Form
                                    </amexio-header>
                                    <amexio-body>
                ...
                <amexio-card [header]="true">
                    ...
                    <amexio-body>
                        <amexio-row>
                            ...
                            <amexio-column [size]="4">
                                <amexio-button type="success" (onClick)="toggleBasicWindow('nonmaterial')" label="Basic Window"></amexio-button>
                                <amexio-window [body-height]="40" [(show)]="showBasicWindowNonMaterial" [close-on-escape]="true" [material-design]="false"
                                    [footer]="true" [vertical-position]="'top'" [horizontal-position]="'center'">
                                    <amexio-header>
                                        Employee Form
                                    </amexio-header>
                                    <amexio-body>
                            ...
                            <amexio-column [size]="4">
                                ...
                                <amexio-window [(show)]="showMaxWindowNonMaterial" [footer]="true" [material-design]="false" (close)="toggleMaxWindow('nonmaterial')"
                                    [maximize]="true">
                                    <amexio-header>
                                        Employee Form
                                    </amexio-header>
                            ...
                            <amexio-column [size]="4">
                                ...
                                <amexio-window [(show)]="showClosableNonMaterial" [close-on-escape]="false" [material-design]="false" [closable]="true" (close)="toggleClosable('nonmaterial')">
                                    <amexio-header>
                                        Employee Form
                                    </amexio-header>
                                    <amexio-body>
            ...
            <amexio-tab title="API Reference">
                ...
                <amexio-datagrid title="Properties" [enable-column-fiter]="false" [http-method]="'get'" [http-url]="'assets/apireference/panes/window/window.json'"
