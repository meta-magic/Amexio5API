...
export class CardFormDemo {
  ...
  getHtmlAndTypeScriptCode() {
    ...
    //HTML FILE
    this.http.get('assets/data/code/layout/card/layout.html',{responseType: 'text'}).subscribe(data => {
      responseHtml = data;
    }, error => {
    }, () => {
    ...
    //TS FILE
    this.http.get('assets/data/code/layout/card/layout.text',{responseType: 'text'}).subscribe(data => {
      responseTs = data;
    }, error => {
    }, () => {
