    ...
    <amexio-card header="true">
      ...
      <amexio-body>
        ...
        <amexio-tab-view>
          ...
          <iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-v4-left-aligned-vertical-tab" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
