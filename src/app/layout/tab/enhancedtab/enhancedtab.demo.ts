        ...
        <amexio-tab-view>
          ...
          <amexio-body>
              <amexio-tab-view [closable]="false" header="Work Profile" [header-align]="'right'" [divide-header-equally]=false>
                  ...
                  <amexio-tab title="Notes" [amexio-color]="'green'">
                      Notes Phasellus in condimentum elit. In et vestibulum sem. Orci varius natoque penatibus et magnis dis parturient montes,
                      nascetur ridiculus mus. Aliquam erat volutpat.Sed viverra libero vel massa accumsan aliquet. Mauris a dui
                      nec sapien pretium euismod.
                  </amexio-tab>
              </amexio-tab-view>
          </amexio-body>
      </amexio-card>
         ...
         <amexio-card [header]="true" [footer]="false" [footer-align]="'right'">
          ...
          <amexio-body>
              <amexio-tab-view [divide-header-equally]="true" header="Person Profile" [header-align]="'right'" [tab-position]="'top'">
                  <amexio-tab title="Personal" [amexio-color]="'red'" [active]="true">
                      Personal Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                      dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
                      type specimen book.
                  </amexio-tab>
                  <amexio-tab title="Work" [amexio-color]="'blue'" [active]="false">
                      Work Nullam nec dolor lobortis, dictum dolor ac, suscipit massa. Donec id suscipit nisi. Nunc sit amet aliquet risus. Aenean
                      placerat suscipit risus at mollis. Quisque eleifend gravida scelerisque. In non eleifend nisi. Phasellus
                      tempor hendrerit posuere. Praesent ornare rutrum mi et condimentum.
                  </amexio-tab>
                  <amexio-tab title="Notes" [amexio-color]="'orange'" [active]="false">
                      Notes Phasellus in condimentum elit. In et vestibulum sem. Orci varius natoque penatibus et magnis dis parturient montes,
                      nascetur ridiculus mus. Aliquam erat volutpat.Sed viverra libero vel massa accumsan aliquet. Mauris a dui
                      nec sapien pretium euismod.
                  </amexio-tab>
