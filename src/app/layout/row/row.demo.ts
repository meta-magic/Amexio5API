    ...
    <amexio-card header="true">
      ...
      <amexio-body>
        ...
        <amexio-tab-view>
          ...
          <iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/angular-v4-rowlayout?embed=1&file=main.ts" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
