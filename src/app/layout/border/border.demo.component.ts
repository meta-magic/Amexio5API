     ...
     <amexio-body>
       ...
       <amexio-tab-view>
         ...
         <amexio-tab title="API Reference">
           <amexio-datagrid title="Properties <amexio-borderlayout>" [enable-column-fiter]="false"
                            [http-method]="'get'"
                            [http-url]="'assets/apireference/border/borderlayout.component.json'"
           ...
           [http-method]="'get'"
           [http-url]="'assets/apireference/border/borderlayoutitem.component.json'"
           [data-reader]="'properties'"
           [enable-data-filter]="false" >
<amexio-data-table-column [width]="15" [data-index]="'name'" [data-type]="'string'" [hidden]="false"
                       [text]="'Name'"></amexio-data-table-column>
...
export class BorderDemoComponent {
  ...
  getHtmlAndTypeScriptCode() {
    ...
    //HTML FILE
    this.http.get('assets/data/code/border/border.html',{responseType: 'text'}).subscribe(data => {
      responseHtml = data;
    }, error => {
    }, () => {
    ...
    //TS FILE
    this.http.get('assets/data/code/border/border.text',{responseType: 'text'}).subscribe(data => {
      responseTs = data;
    }, error => {
    }, () => {
