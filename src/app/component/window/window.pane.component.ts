...
import { AmexioWindowHeaderComponent } from 'amexio-ng-extensions';

export enum KEY_CODE_window {
  esc = 27,
}
@Component({
  selector: 'amexio-window1',
...
export class AmexioWindowPaneComponent1 implements OnChanges, OnInit, OnDestroy {
  /*
   Properties
