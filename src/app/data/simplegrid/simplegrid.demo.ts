            ...
            <amexio-row>
              <amexio-column size="12">
                <amexio-card [header]="true">
                  ...
                  <amexio-body>
                    <amexio-datagrid
                      [enablecolumnfiter]="true" title="Country Grid" [enablecheckbox]="false"  [httpmethod]="'get'" [httpurl]="'assets/data/componentdata/country.json'" [datareader]="'data'"  [pagesize] = "10">
