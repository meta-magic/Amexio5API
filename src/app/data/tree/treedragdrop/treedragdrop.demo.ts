...
@Component({
  selector: 'dragdroptree-demo', template: `
    <amexio-card header="true">
      ...
      <amexio-body>
        <p>A Expandable Tree component which create Tree View based on standard datasource attached and having functionality of drag and drop (within tree as well as across tree)</p>
        <amexio-tab-view>
...
<amexio-card [header]="true" [footer]="false" [footer-align]="'right'">
    ...
    <amexio-body>
        <amexio-row>
          ...
          <iframe style="width: 100%; height: 600px" src="https://stackblitz.com/edit/amexio-v4-dragdrop?embed=1&file=app/tree/acrosstree/acrosstree.demo.html" frameborder="0" allowfullscren="allowfullscren"></iframe>
          </amexio-tab>
        </amexio-tab-view>
      </amexio-body>
    </amexio-card>
